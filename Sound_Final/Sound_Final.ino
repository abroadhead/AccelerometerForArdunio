<<<<<<< HEAD:Sound_Final/Sound_Final.ino
...
void loop() {
  ...
  if (tempZ < 0.6) {  //
    if (gForceX < 0.5 and gForceY < 0.5) { //Test if tilted to the side
      Serial.println("Fall Detected, Checking... ");
      ...
      Serial.println("Titled to the side!");
    }
  }
  else
  {  //if false, do nothing
...
>>>>>>> 31b2cde8257ea1baed673ddc2675a03a3af1d4bd:Sound_Final.ino
